/**
 * @file    Font6.c
 * @brief   4x6 bitmap font based on Tom Thumb monospace font.
 *          Each character is 4 pixels wide, 6 pixels tall.
 *          1 byte per row, MSB-first, upper 4 bits used (bits 7-4).
 *          ASCII 32-126 (95 characters, 6 bytes each = 570 bytes).
 */

#include "font.h"

static const uint8_t Font6_Table[] =
{
    // ' ' (32)
